...
<summary>List of things to do</summary>
...
- Code sample section updates - Need to add authentication and extensions - Check [Related feature](https://github.com/Azure-Samples/modern-data-warehouse-dataops/issues/715)
...
<summary>1. Attached span</summary>

*Attached spans* which have *implicit context propagation*.
...
<summary>2. Dettached span</summary>

*Detached spans* which needs to have *context set explicitly*.
...
<details>
<summary>Open telemetry SDK</summary>
...
<summary>Using the Opentelemetry SDK example</summary>
...
<details>
<summary>Sample telemetry schema</summary>
...
<details>
<summary>Collector configuration file</summary>
